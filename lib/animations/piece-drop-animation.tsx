...
import { mergeSx, random } from 'lib/utils';
      ...
      result.push({
        ...
        animation: {
          initial: {
            top: '-10%',
            left: `${left}%`,
            transform: `rotateX(${xRotate}deg) rotateY(${yRotate}deg) rotateZ(${zRotate}deg)`,
          },
          final: {
            top: '110%',
            left: `${left + leftRange}%`,
            transform: `rotateX(${finalXRotate}deg) rotateY(${finalYRotate}deg) rotateZ(${finalZRotate}deg)`,
          },
        },
